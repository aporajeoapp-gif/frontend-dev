...
const { profile } = fetchUser();
  ...
  useEffect(() => {
    setParams((p) => ({ ...p, category: categoryFilter, page: 1 }));
  }, [categoryFilter]);
    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        ...
        <select
          ...
          className="w-full max-w-xs px-3 py-2 text-sm bg-slate-100 dark:bg-slate-800 rounded-lg border border-transparent focus:border-primary-400 outline-none text-slate-700 dark:text-slate-300 transition-colors"
        >
