...
export default function Emergency() {
  ...
  const { emergencies = [], pagination, loading, refresh } = useEmergencyServices();
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="flex w-full min-w-0 gap-2 sm:w-auto">
            ...
            <div className="relative min-w-0 flex-1 sm:flex-none">
              ...
              <select
                ...
                className="h-11 w-full min-w-0 pl-10 pr-9 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-sm text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-rose-500/50 appearance-none transition-colors sm:min-w-[160px]"
              >
        ...
        {loading ? (
          <ListLoader label="Loading emergency services..." />
        ) : (
